...
create_beautiful_grid <- function(model_type, transition) {
  ...
  # Create individual panels (only first panel shows legend)
  cat("  Creating panels...\n")
  panels <- list()
  idx <- 1
  for (R0_val in R0_VALUES) {
            ...
            <div class="info-grid">
                <div class="info-card">
                    ...
                    <p><strong>Size:</strong> 100,000<br>
                       ...
                       <strong>Simulations:</strong> 100 per scenario</p>
                </div>
                <div class="info-card">
                    <h3>🦠 Disease Model</h3>
                ...
                <div class="info-card">
                    ...
                    <p><strong>Full Model:</strong> Contact rate = 20<br>
                       <strong>Partial Model:</strong> Erdős-Rényi network, avg degree = 10<br>
                       <strong>Days simulated:</strong> 150</p>
                </div>
                <div class="info-card">
                    <h3>📈 R₀ Values Tested</h3>
                    <p><strong>Basic reproduction numbers:</strong><br>
                       R₀ = 1.5, 2.0, 3.0, 5.0<br>
                       <strong>Transmission rate:</strong> Calculated as R₀ × recovery_rate / contact_rate</p>
                </div>
                <div class="info-card">
                    <h3>⏱️ Serial Intervals</h3>
                ...
                <div class="info-card">
                    ...
                    <p><strong>S → E:</strong> Susceptible to Exposed<br>
                       ...
                       Both transitions analyzed separately for R<sub>t</sub> estimation</p>
                </div>
                <div class="info-card">
